...
<section id="main-content">
          <section class="wrapper">
              ...
              <div class="form-group">
                                                <div class="col-sm-7">
                                                  <button class="btn btn-theme btn-block" type="button"><a href="select_pending_event.php?action=sen">Search event by name</a></button>
                                                </div>
                                                <br>
                                                <br>
                                                <br>
                                                <div class="col-sm-7">
                                                  <button class="btn btn-theme btn-block" type="button"><a href="select_pending_event.php?action=seda">Search event by date</a></button>
                                                </div>
                                                <br>
                                                <br>
                                                <br>
                                                ...
                                                <div class="col-sm-7">
                                                  <button class="btn btn-theme btn-block" type="button"><a href="select_pending_event.php?action=sede">Search event by department</a></button>
                                                </div>
...
if(@$_GET['action']=='sen')
{
	?>
  <br>
	<form action="select_pending_event.php?action=sen" method="POST" class="form-group">
...
if(@$_GET['action']=='seda') {
	?>
      <form action="select_pending_event.php?action=seda" method="POST">
...
if(@$_GET['action']=='sede')
{
	?>
  <br>
	<form action="select_pending_event.php?action=sede" method="POST">
