                               ...
                               <label class="checkbox-inline">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="radio">
                                          <label>
                                            <input type ="radio" name="group1" value="Curricular Activity" checked onclick="hide_dropdown();" checked>
                                            CURRICULAR ACTIVITY
                                          </label>
                                        </div>
                                        <div class="radio">
                                          <label>
                                            <input type="radio" name="group1" value = "Co-Curricular Activity"  onclick="show_dropdown();">
                                        ...
                                        <div id="drop_down">
                                                  ...
                                                  <option value="" disabled selected>Choose your option</option>
                                                    ...
                                                    <option value="industrial institute_activity">Industrial Institute Activity</option>
                                                    ...
                                                    <option value="sports activity">Sports Activity Event</option>
