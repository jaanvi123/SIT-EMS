                              ...
                              <div class="col-sm-10">
                                  <?php echo("<input value='".$event_name."' type='text' class='form-control' id='Name of the event' name='event_name'>");?>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <p />
                                          <label>
                                            <input type="radio" id='reverb' name="event" value="reverb" onclick="hide_checklist();">
                                            Reverb
                                          </label>
                                          ...
                                          <label>
                                            <input type="radio" id='EPIC' name="event" value="EPIC" onclick="hide_checklist();">
                                            EPIC
                                          </label>
                                        ...
                                        <p />
                                          <label>
                                            <input type="radio" id='Other Club Activity' name="event" value="Other Club Activity" onclick="hide_checklist();">
                                            Other Club Activity
                                          </label>
      ...
      ?>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="radio">
                                          <label>
                                            <input type="radio" id='co_curricular' name="group1" value = 1 onclick="show_dropdown();">
